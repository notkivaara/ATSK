 ...
 * @author ACER
 */
public class Popup_Tambah_Pengeluaran_Shadow extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Popup_Tambah_Pengeluaran_Shadow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Popup_Tambah_Pengeluaran_Shadow().setVisible(true);
            }
        });
    }
